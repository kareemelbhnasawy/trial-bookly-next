...
const defaultGateways: PaymentGateway[] = [
  {
    ...
    fees: { percentage: 1.5, fixed: 0, currency: "SAR" },
    minAmount: 1,
    maxAmount: 100000,
  ...
  },
  {
    ...
    isEnabled: true,
    supportedCurrencies: ["SAR"],
    fees: { percentage: 1.0, fixed: 0, currency: "SAR" },
    minAmount: 1,
    maxAmount: 10000,
    logo: "/payment-gateways/stc-pay.png",
  },
  {
    id: "apple_pay",
    name: "Apple Pay",
    ...
    fees: { percentage: 2.0, fixed: 0, currency: "SAR" },
    minAmount: 1,
    maxAmount: 25000,
    logo: "/payment-gateways/apple-pay.png",
  },
  {
    id: "bank_transfer",
    name: "Bank Transfer",
    ...
    isEnabled: true,
    supportedCurrencies: ["SAR"],
    fees: { percentage: 0, fixed: 10, currency: "SAR" },
    minAmount: 100,
    maxAmount: 1000000,
  ...
  },
  {
    ...
    isEnabled: true,
    supportedCurrencies: ["SAR"],
    fees: { percentage: 0, fixed: 25, currency: "SAR" },
    minAmount: 50,
    maxAmount: 5000,
